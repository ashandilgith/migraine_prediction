...
with gr.Blocks(theme=gr.themes.Soft(primary_hue="teal")) as demo:
    ...
    with gr.Row(visible=True) as login_view:
        with gr.Column(scale=2):
            gr.Image("https://images.pexels.com/photos/12689421/pexels-photo-12689421.jpeg",
                     label="Welcome", show_label=False, show_download_button=False, container=False, min_width=600)
        with gr.Column(scale=1, min_width=500):
            gr.Markdown("## Hello champion! Log into Migraine Gabay")
            gr.Markdown("""
            - *Log daily, food, sleep and migraine patterns for 30 days
            - *Train your own AI model to make migraine forecasts
            - *Predict migraines before they occur based on your personal triggers
            """)
